...
Concatenation-based fusion is widely adopted for its simplicity and robustness~\cite{Liuspectral,wang2019edvr}.
...
\begin{itemize}
  ...
  \item \textbf{Code availability}: The source code is publicly available at \url{https://github.com/TimeSavingZzz/ShaDocFormer}.
